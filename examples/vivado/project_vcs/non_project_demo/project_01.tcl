...
#
# project_01.tcl: Tcl script for re-creating project 'project_01'
#
# Generated by Vivado on Tue May 30 10:14:10 +0100 2023
...
#
# 1. This project restoration tcl script (project_01.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Local/astephen/git-wd/SPARTAN7_XC7S15_FTGB196/SW/project_01_led/project_01_led/led_top.v"
#    "C:/Local/astephen/git-wd/SPARTAN7_XC7S15_FTGB196/SW/project_01_led/project_01_led/project_01.srcs/constrs_1/new/led_top.xdc"
#    "C:/Local/astephen/git-wd/SPARTAN7_XC7S15_FTGB196/SW/project_01_led/project_01_led/project_01.srcs/sim_1/new/led_top_tb.v"
#
...
set _xil_proj_name_ "project_01"
...
set script_file "project_01.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../git-wd/SPARTAN7_XC7S15_FTGB196/SW/project_01_led/project_01_led"]"
...
# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -part xc7s15ftgb196-1
...
set_property -name "part" -value "xc7s15ftgb196-1" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/../git-wd/SPARTAN7_XC7S15_FTGB196/SW/project_01_led/project_01_led/led_top.v" ]\
]
...
set file "project_01_led/led_top.v"
...
set file "[file normalize "$origin_dir/../git-wd/SPARTAN7_XC7S15_FTGB196/SW/project_01_led/project_01_led/project_01.srcs/constrs_1/new/led_top.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/led_top.xdc"
...
set_property -name "target_part" -value "xc7s15ftgb196-1" -objects $obj
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/../git-wd/SPARTAN7_XC7S15_FTGB196/SW/project_01_led/project_01_led/project_01.srcs/sim_1/new/led_top_tb.v" ]\
]
...
set_property -name "top" -value "led_top_tb" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7s15ftgb196-1 -flow {Vivado Synthesis 2018} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7s15ftgb196-1 -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
